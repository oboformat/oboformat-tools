...
public class GuiMainPanel extends SizedJPanel {
     ...
     * @param obo2owl
     */
    public GuiMainPanel(GuiMainFrame frame, Iterable<String> defaultInputFiles,
            String defaultOutputFile, boolean obo2owl) {
        super();
        this.frame = frame;
        ...
        addLabelLine(pos,
                "Minimal options required to convert an ontology file");
    ...
    private void createInputPanel(GBHelper pos, String defaultFolder) {
        final SelectDialog dialog = SelectDialog.getFileSelector(frame,
                SelectDialog.LOAD, defaultFolder,
                "Input ontology file choose dialog", "OBO & OWL files",
                new String[] { "obo", "owl" });
    ...
    private void createOutputPanel(GBHelper pos, String defaultFolder) {
        final SelectDialog fileDialog = SelectDialog.getFileSelector(frame,
                SelectDialog.SAVE, defaultFolder,
                "Output ontology file choose dialog", "OBO & OWL files",
                new String[] { "obo", "owl" });
