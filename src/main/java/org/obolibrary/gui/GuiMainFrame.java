...
public class GuiMainFrame extends JFrame {
     ...
     * 
     * @param logQueue
     *        Message queue for events to be shown in the log panel
     * @param config
     *        Default configuration, may contain parsed parameters from the
     *        command line.
     */
    public GuiMainFrame(BlockingQueue<String> logQueue,
    ...
    private void
            addTab(JTabbedPane tabbedPane, String title, SizedJPanel panel) {
    ...
    /**
     * Execute the actual conversion. Override this method to implement the call
    ...
    synchronized GuiAdvancedDirectionSpecificPanel getSpecificAdvancedPanel() {
        if (specificAdvancedPanel == null) {
            specificAdvancedPanel = new GuiAdvancedDirectionSpecificPanel(
                    ...
                    config.defaultOnt.getValue(), config.isOboToOwl.getValue(),
