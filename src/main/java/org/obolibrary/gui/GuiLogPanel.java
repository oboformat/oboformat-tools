...
/**
 * Panel for rendering the log in the GUI. This component relies on the
 * assumption, that all events are put in the logQueue. This is can be done with
 * a registered logAppender.
 */
