...
public class GuiAdvancedDirectionSpecificPanel extends SizedJPanel {
    ...
    public GuiAdvancedDirectionSpecificPanel(boolean allowDanglingDefault,
            ...
            String defaultOntologyConfigValue, boolean isObo2Owl,
        ...
        expandMacrosCheckbox = new JCheckBox("Expand OWL Macros",
                expandMacrosDefault);
    ...
    /**
     * Set the advanced tab options to reflect the selected conversion direction
     * 
     * @param isObo2Owl
     */
