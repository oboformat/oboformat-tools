...
public class GuiAdvancedPanel extends SizedJPanel {
    ...
    public GuiAdvancedPanel(Frame frame,
        ...
        if (defaultDownloadOntologies != null
                && !defaultDownloadOntologies.isEmpty()) {
        ...
        downloadOntologiesCheckBox = new JCheckBox("Download Ontologies",
                downloadOntologiesCheckBoxIsActive);
        ...
        if (defaultOmitDownloadOntologies != null
                && !defaultOmitDownloadOntologies.isEmpty()) {
            StringBuilder sb = new StringBuilder();
        ...
        omitDownloadOntologiesCheckBox = new JCheckBox(
                "Omit Download Ontologies",
                omitDownloadOntologiesCheckBoxIsActive);
        ...
        // download ontologies
        createOntologiesPanel(pos, downloadOntologies,
                downloadOntologiesCheckBox);
        addRowGap(this, pos, 5);
        // work dir for downloading ontologies
        createDownloadDirPanel(pos, defaultBuildDir);
        addRowGap(this, pos, 5);
        // omit download ontologies
        createOntologiesPanel(pos, omitDownloadOntologies,
                omitDownloadOntologiesCheckBox);
        addRowGap(this, pos, 5);
    }
    ...
    private void createDownloadDirPanel(GBHelper pos, String defaultFolder) {
        final SelectDialog dialog = SelectDialog.getFolderSelector(frame,
                defaultFolder, "Work directory choose dialog");
    ...
    /**
     * Layout and events for the input of ontologies to be downloaded or
     * omitted.
     * 
     * @param pos
     * @param ontologyList
     * @param checkBox
     */
    private void createOntologiesPanel(GBHelper pos,
            final JTextArea ontologyList, final JCheckBox checkBox) {
        ...
        add(scrollPane, pos.nextCol().expandW().expandH().anchorCenter().fill()
                .height(3));
        pos.nextRow();
        pos.nextRow();
    }
