...
public class GuiTools {
    ...
    /**
     * Add an additional row with a fixed size for layout purposes. Works only
     * with {@link GridBagLayout} and {@link GBHelper}.
     * 
     * @param panel
     *        The panel to layout
     * @param pos
    ...
    public static List<String> getStrings(JTextArea jTextArea) {
        ...
        for (int i = 0; i < contentCount; i++) {
            ...
            try {
                String line = document.getText(rangeStart,
                        rangeEnd - rangeStart).trim();
                list.add(line);
            } catch (BadLocationException exception) {
                throw new RuntimeException("Could not parse text in area",
                        exception);
            }
        }
        return list;
    ...
    public static class GBHelper extends GridBagConstraints {
        ...
        /**
         * Increase indent in the left. Return new instance to minimize side
         * effects.
         * 
         * @param pixel
         * @return helper
        ...
        public GBHelper indentLeft(int pixel) {
            ...
            duplicate.insets = new Insets(this.insets.top, this.insets.left
                    + pixel, this.insets.bottom, this.insets.right);
            return duplicate;
        }
        ...
        public GBHelper indentRight(int pixel) {
            GBHelper duplicate = (GBHelper) this.clone();
            duplicate.insets = new Insets(this.insets.top, this.insets.left,
                    this.insets.bottom, this.insets.right + pixel);
            return duplicate;
        }

        /**
         * Set the anchor to center. Return new instance to minimize side
         * effects.
         * 
         * @return helper
         */
        ...
        /**
         * Sets the height of the area in terms of rows. Return new instance to
        ...
        /**
         * Sets the width of the area in terms of rows. Return new instance to
         * minimize side effects.
         * 
         * @param columnsWide
         * @return helper
        ...
        /**
         * Set the fill to both. The component tries to fill the cell in both
         * directions. Return new instance to minimize side effects.
         * 
         * @return helper
         */
