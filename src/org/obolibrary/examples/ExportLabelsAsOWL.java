...
public class ExportLabelsAsOWL {
	...
	public static void main(String[] args) throws IOException, OWLOntologyCreationException, OWLOntologyStorageException {
		...
		// we will be exporting only labels. Get the RDFS vocabulary IRI for this
		IRI rdfsLabelIRI = OWLRDFVocabulary.RDFS_LABEL.getIRI();
		
		// create a new ontology o2. o2 will be a copy of o1, with a new IRI, and will
		// include only label assertions from o
		OWLOntology ontology2 = manager.createOntology(IRI.create("http://example.org"));
		
		// iterate through all classes in the ontology adding class declarations to o2, and label assertions
