...
public class Obo2OwlTest extends TestCase {
	...
	public static void testConvertCARO() throws IOException, OWLOntologyCreationException, OWLOntologyStorageException {
		OWLOntology owlOnt = convertOBOFile("caro.obo");	
	}
	public static void testConvertXPWithQV() throws IOException, OWLOntologyCreationException, OWLOntologyStorageException {
