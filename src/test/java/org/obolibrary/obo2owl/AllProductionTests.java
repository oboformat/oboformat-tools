...
@Suite.SuiteClasses({
        ...
        // oboformat tests
        CAROTest.class, SimpleGOTest.class, SingleIntersectionOfTagTest.class,
        TagTest.class, XrefExpanderTest.class, OboEscapeCharsTest.class,
        ChebiXRefTest.class, EmptyLinesTest.class, PropertyValueTest.class,
        OBOFormatWriterTest.class, MultipleCommentsTest.class,
        IgnoreImportAnnotationsTest.class, IdSpaceTest.class,
        TrailingQualifierTest.class, CurlyBracesInCommentsTest.class,
        TypeDefCommentsTest.class,
        // macro expansion
        ExpandSynapsedToTest.class, ExpandExpressionTest.class,
        ExpandExpressionGCITest.class, ManchesterSyntaxToolTest.class })
